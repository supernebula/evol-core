...
namespace Evol.Domain.Uow
{
    ...
    public class CallContextCurrentUnitOfWorkProvider : ICurrentUnitOfWorkProvider
    {
        ...
        private const string ContextKey = "Evol.Uow.Current";
        ...
        public CallContextCurrentUnitOfWorkProvider(object logger)
        {
        ...
        {
            var unitOfWorkKey = _asyncLocal.(ContextKey) as string;
